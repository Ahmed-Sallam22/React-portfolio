    ...
    <>
      <div className="portfolio position-relative w-100 bg-white py-5">
        <div className="container mt-5">
          ...
          <div id="pro" className="content position-relative pb-4 mb-5 ">
              ...
              <div className="modal-dialog mw-100 w-75">
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-header">
                    ...
                    <div id="pro" className="content position-relative pb-4 my-3 ">
                        <h2 className="text-uppercase text-center fw-bolder fs-1" id="exampleModalLabel">{nameHeader}</h2>
                              <div className="lines d-flex align-items-center justify-content-center">
                    <div className="line"></div>
                    <i className="fa-solid fa-star fa-2xl px-3"></i>
                    <div className="line"></div>
